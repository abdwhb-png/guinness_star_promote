            ...
            <div class="pt-4 grid grid-cols-2 gap-4" v-if="isSuccess">
                ...
                >
                    <a
                        ...
                        class="rounded-xl relative overflow-hidden block liner-bg-1"
                    >
                        <div
                            v-lazy-container="{
                                selector: 'img',
                    ...
                    <div
                        @click="userStore.toggleDealFavourite(item)"
                    ...
                    >
                        <i
                            class="ph-heart-straight text-g60"
                            :class="item.isLiked ? 'ph-fill' : 'ph'"
                        ></i>
                    </div>
                    <div  class="pt-1">
                        <p class="truncate mt-2">
                            <a :href="item.spotify_url || 'javascript:void(0)'" target="_blank" class="text-g60 hover:text-sky-500 text-base font-semibold">
                            {{ item.name }}
                        </a>
                        </p>
                        <div class="flex justify-between items-center">
                            <p
                                class="text-g60 font-semibold text-xs"
                                style="text-transform: capitalize"
                            >
                                {{ item.category }}
                            </p>
                            <i
                                class="ph ph-dot text-3xl text-g50 leading-none"
                            ></i>
                    ...
                    <a
                        href="javascript:void(0)"
                        class="text-g60 font-semibold text-sm"
                    >
                        <span class="font-normal text-g40">
                            {{ 'Popularity' }}</span
                        >
