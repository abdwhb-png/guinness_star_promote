...
(function () {
    ...
    var flags_location =
        gt.flags_location || "https://cdn.gtranslate.net/flags/";
    var url_structure = gt.url_structure || "none";
    var custom_domains = gt.custom_domains || {};
    var switcher_horizontal_position =
        gt.switcher_horizontal_position || "left";
    var switcher_vertical_position = gt.switcher_vertical_position || "bottom";
    var float_switcher_open_direction =
        gt.float_switcher_open_direction || "top";
    ...
    widget_css +=
        ".gt_float_switcher .gt_options::-webkit-scrollbar{width:5px}";
    widget_css +=
    ...
    function gt_hscroll(evt) {
        ...
        if (evt.type == "mousewheel") {
            ...
            gt_touchstart_posx = gt_touchstart_posx_static =
                evt.touches[0].pageX;
    ...
    function gt_hide_float_switcher() {
        ...
        document
            .querySelectorAll(
                u_class + " .gt_float_switcher .gt_options.gt-open"
            )
            .forEach(function (e) {
                if (
                    float_switcher_open_direction == "left" ||
    ...
    document
        .querySelectorAll(u_class + " div.gt-selected")
        .forEach(function (e) {
            e.addEventListener("click", function (evt) {
                evt.stopPropagation();
            ...
            if (url_structure == "none") {
                ...
                window.gt_translate_script.onload = function () {
                    ...
                    el.querySelectorAll("img:not([src])").forEach(function (e) {
                        e.setAttribute(
                            "src",
                            e.getAttribute("data-gt-lazy-src")
                        );
                    });
